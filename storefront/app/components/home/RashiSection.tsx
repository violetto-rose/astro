...
export function RashiSection({
  ...
  return (
    <section className="bg-secondary-50/80 border-y border-secondary-200 py-12 mt-6">
              ...
              >
                <div className="h-10 w-10 mx-auto rounded-full bg-primary-50 border border-secondary-200 flex items-center justify-center text-primary-700">
                  <span
                    ...
                    className="h-10 w-10 inline-block bg-current"
                    style={{
